...
- **Target aesthetic:** which feeling it produces.
- **Minimal rules:** simplest rule set that produces this mechanic.
- **Expected dynamics:** what player behaviour this will produce.
- **Comparable precedent:** a shipped game that used this or something similar.
- **Risk/unknowns:** what needs to be validated.

<!-- Repeat for each essential mechanic. -->
...
- [ ] Core loop is explicit at all three time horizons.
- [ ] All essential mechanics are named and justified.
- [ ] Progression structure is addressed.
- [ ] Onboarding approach is specified.
- [ ] Technical assumptions are explicit.
- [ ] The package is compact enough to be revised easily.
